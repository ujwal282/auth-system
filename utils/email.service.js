...
/**
 * Core email sender (replacement for nodemailer transporter)
 */
...
const sendVerificationEmail = async (user, VerificationUrl) => {
  try {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p class="text">
              Welcome to SecureAuth! Please verify your email address to get full access to your account.
    ...
    await sendEmail(
      user.email,
      "Verify your email address - SecureAuth",
      html
    );
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p class="text">
              ...
              Click below to choose a new one. This link expires in 15 minutes.
            </p>
          ...
          <div class="footer">
            <p class="footer-text">Password reset requested for SecureAuth account.</p>
            <p class="footer-text">© ${new Date().getFullYear()} SecureAuth</p>
          </div>
        </div>
      </body>
